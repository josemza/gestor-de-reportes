...
class Usuario(Base):
    ...
    id: Mapped[int] = mapped_column("USUARIO_ID", Integer, primary_key=True)
...
class Rol(Base):
    ...
    id: Mapped[int] = mapped_column("ROL_ID", Integer, primary_key=True)
...
class UsuarioRol(Base):
    ...
    id: Mapped[int] = mapped_column("USUARIO_ROL_ID", Integer, primary_key=True)
...
class Equipo(Base):
    ...
    id: Mapped[int] = mapped_column("EQUIPO_ID", Integer, primary_key=True)
...
class UsuarioEquipo(Base):
    ...
    id: Mapped[int] = mapped_column("USUARIO_EQUIPO_ID", Integer, primary_key=True)
    usuario_id: Mapped[int] = mapped_column("USUARIO_ID", ForeignKey("USUARIOS_REP_GCI.USUARIO_ID"), nullable=False)
